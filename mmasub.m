...
f0val,df0dx,fval,dfdx,low,upp,a0,a,c,d,beta,move);
%
...
% move = 0.2;
albefa = 0.1;
asyinit = 0.5/(max(beta(1),1));

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
asyincr = 1.05;   % 1.05 (normal); 1.15 (wide); 1.0 (tight) 
asydecr = 0.85;   % 0.85 (normal); 0.65 (wide); 0.95 (tight) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
